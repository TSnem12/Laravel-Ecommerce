                ...
                <div class="row"> <!-- start 4th row  -->
			        ...
			        <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="product_size_ar" class="form-control" value="Small,Midium,Large" data-role="tagsinput">
                ...
                <div class="row"> <!-- start 8th row  -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="" required placeholder="Textarea text"></textarea>  
                            </div>
                        </div>
			        </div> <!-- end col md 6 -->
			        ...
			        <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <textarea id="editor2" name="long_descp_ar" rows="10" cols="80" required="" required placeholder="Textarea text"></textarea>       
                            </div>
                        </div>
			        </div> <!-- end col md 6 -->		 
