                        ...
                        <div class="col-12">						
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            <img id="show_image" src="{{ !empty($editData->profile_photo_path) ? url('upload/admin_images/'.$editData->profile_photo_path) : url('upload/no_image.jpg') }}" style="width: 100px; height: 100px;">
                                        </div>
                                    </div>
                                </div>
